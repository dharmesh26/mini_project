		...
		<div class="container">
			...
			<div class="container">
				 <?php
                        ...
                        $sql="SELECT * FROM employee WHERE id='$employ_id'";
                        $sql1="SELECT from_date,to_date FROM leaves WHERE id='$leave_id'";
				...
				?>
					...
					<div class="col justify-content-center d-inline-flex">
						<div class="mt-5 text-danger">From Date:<br> <?php echo $row1['from_date'];?></div>
						<div class="ml-5 mt-5 text-danger">To Date: <br><?php echo $row1['to_date'];?></div>
					</div>
					
					<div class="col justify-content-center d-inline-flex">
						<form action="grantLeave.php">
							<input type="submit" class="btn btn-outline-dark mt-4" value="Grant Leave">
						</form>
						<form action="rejectLeave.php">
						<input type="submit" class="btn btn-outline-dark mt-4 ml-3" value="Reject Leave">
						</form>
					</div>
